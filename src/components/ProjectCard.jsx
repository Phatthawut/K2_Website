        ...
        return (
            <section className="flex justify-center w-full">
                ...
                <div className="flex w-full text-white md:text-3xl ">
                    <img className="w-3/5 bg-cover bg-center bg-neutral-400" src={projectImage} alt={`${projectName} image`} />
                    <div style={{ backgroundImage: `url(${projectBGImage})` }} className="w-2/5 bg-cover bg-center flex flex-col justify-center font-semibold px-4 py-4 gap-3 bg-slate-500">
