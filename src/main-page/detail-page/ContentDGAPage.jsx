...
function ContentDGAPage() {
	...
	const projectDescription = {
		...
		projectDescription:
			"รับชมผลงานเต็มได้ที่ Vimeo K2 <!--link:https://vimeo.com/722851862-->https://vimeo.com/722851862<!--endlink-->",
	};
