...
function BrandingNongmonPage () {
    ...
    const descriptionLists = [
        ...
        {
        listname: 'Logo',
        description: 'ในส่วนของโลโก้นั้นจะใช้เป็น Combination Logo ผสมผสานระหว่าง Typeface และ Symbol เน้นแบบสีขาวที่อยู่บนพื้นหลังสีแดงเป็นหลัก เพราะสีแดงเป็นสีที่กระตุ้นต่อความอยากอาหารได้ดีและสื่อถึงความมีพลัง ตัวอักษรที่ใช้จะเป็นตัวอักษรหนา ที่เพิ่มความน่าสนใจด้วยการใช้สัญลักษณ์ที่ถูกตัดทอนมาจากอาหารขึ้นชื่อของหนองมนวางแทนลงไปบนตัว ‘O’ เพื่อสร้างจุดเด่นให้กับโลโก'},
        {
        ...
        {
        listname: 'Typeface',
        description: 'พวกเราได้เลือก ‘Archivo’ และ ‘Prompt’ มาเป็น Font ที่ใช้สำหรับแคมเปญนี้ โดย Archivo เป็น Font ที่มีลักษณะเป็นแบบ Sans serif font เน้นใช้งานสำหรับพวกหัวข้อหรือใจความสำคัญต่างๆ อีกทั้งยังเป็น Font ที่สามารถใช้งานได้อย่างหลากหลาย เหมาะสมกับทั้งงานบนเว็บไซต์และสื่อสิ่งพิมพ์ อีกทั้งยังมีน้ำหนักของ Font ให้เลือกได้หลายขนาด ซึ่งทำให้สามารถนำไปใช้งานได้อย่างสะดวก Prompt เป็น Font ภาษาไทยที่ไม่มีหัว ตัวกว้าง มีความโมเดิร์น และมีสัดส่วนของทั้งความสูงและความกว้างที่เป็นระบบ ทำให้สามารถนำไปใช้จัดวางในงานดีไซน์ได้อย่างมีประสิทธิภาพ'},
        {
        listname: 'Brand Elements',
        description: 'ในด้านองค์ประกอบของแบรนด์ เราได้นำอาหารที่มีชื่อเสียงของหนองมนมาตัดทอนให้เป็นรูปร่างที่มีความเรียบง่ายและโมเดิร์นขึ้น โดยอาหารที่เรานำมาดัดแปลงรูปทรง ได้แก่ ข้าวหลาม, ฮ่อยจ๊อ และขนมจากรวมไปถึงเราได้สร้างสัญลักษณ์ดอกจันขึ้นมาหลายแบบๆเพื่อเป็นสัญลักษณ์ที่เน้นย้ำถึงความสำคัญของหนองมน ที่ไม่ใช่แค่จุดแวะซื้อของฝาก แต่เป็นจุดหมายที่ใครๆ ก็ห้ามพลาดในการแวะมา โดยองค์ประกอบของแบรนด์สามารถนำไปใช้ตกแต่งได้หลายรูปแบบ เช่น นำไปทำเป็นภาพพื้นหลัง หรือทำเป็นแพทเทิร์นเพื่อสร้างจุดเด่นให้กับงาน'}
    ]
